    ...
    russian: {
        ...
        settings: {
            ...
            notifications: {
                ...
                option1: "Уведомление по Э-почте",
        ...
        homePage: {
            heading1: "Добро пожаловать!",
            subHeader1: "Каждому работнику самая подходящая работа",
            ...
            findTeamMembers: {
                heading: "Найди самых лучших участников для твоей команды для своего проекта",
            ...
            adm: {
                heading: "#AJS",
                subHeading: "Если ты сейчас находишься в активном поиске работы (#AJS), тогда эта роль предназначена для тебя! Добавь её во время регестрации или в любой момент в настройках своего профиля",
                button: "Начать"
            }
        },
        authorizedHomePage: {
            ...
            chat2: "Начать беседу",
            adm: "#AJS",
            longtermJobs: "Долгосрочное",
            shorttermJobs: "Короткое",
            ...
            leftPanel: {
                ...
                contacts: "Контакты",
                findContacts: "Найди свои контакты,чтобы с ними начать общяться",
                saved: "Сохранённые"
            },
            Right: {
                chatHeading: "Чат"
        ...
        profile: {
            ...
            jobSeeker: {
                ...
                previousJob: "Послёдняя должность",
...
heading: "Редактирование профиля",
        ...
        premiumPage: {
            ...
            premiumText1: "Приобретите Премиум, чтобы упростить процесс поиска работы, получить больше информации о выбранной вами работе и получить помощь в создании карьеры",
            premiumText2: "Будь на высоте с Премиум!",
            premiumOptions: {
                jobGiver: {
                    option1: "Доступна статистика какие работники посмотрели ваши вакансии о работе",
                ...
                jobSeeker: {
                    ...
                    option2: "Детальное рассмотрение зрплаты",
        ...
        loginPage: {
            heading: "Подключиться",
            email: "Э-почта",
            incorrectEmail: "Неправильная Э-почта",
            password: "Пароль",
        ...
        footer: {
            ...
            description: "Youth Deal - это более удобная и инновационная среда для рынка труда. Мы даем возможность каждому молодому человеку найти подходящую работу и начать строить карьеру. Также мы помогаем каждому работодателю найти наиболее подходящего сотрудника. -Найдите наиболее подходящее вместе с Youth Deal. "
        },
        cookie: {
            heading: "Здравствуй!",
        ...
        saved: {
            jobType1: "Долгосрочное работы",
            jobType2: "Короткое работы",
            jobType3: "Волонтёрство работы"
        }
    },
};